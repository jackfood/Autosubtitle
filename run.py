...
class SubtitleApp:
    def __init__(self, master):
        ...
        output_dir_label.grid(row=4, column=0, sticky=tk.W, padx=5, pady=(10,2)) 
        ...
        self.output_dir_entry.grid(row=4, column=1, sticky=tk.EW, padx=5, pady=(10,2))
        self.output_dir_button = tk.Button(options_frame, text="Browse...", command=self.select_output_dir)
        self.output_dir_button.grid(row=4, column=2, sticky=tk.EW, padx=5, pady=(10,2))
